...
REM
REM Generated by Vivado on Sun Apr 26 20:28:03 +0800 2026
...
echo "xvlog --incr --relax -prj tb_top_datapath_vlog.prj"
call xvlog  --incr --relax -prj tb_top_datapath_vlog.prj -log xvlog.log
